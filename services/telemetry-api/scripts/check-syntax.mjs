...
const files = collectJavaScriptFiles(path.join(rootDir, 'src'));
...
console.log(`Checked ${files.length} JavaScript files and relative imports in services/telemetry-api/src`);
